...
import com.kzerk.shopppinglist.domain.AddItemUseCase
import com.kzerk.shopppinglist.domain.GetItemByIdUseCase
...
class ShopItemViewModel: ViewModel() {
	...
	private val updateShopItemUseCase = UpdateItemUseCase(repository)
	...
	fun addShopItem(inputName: String?, inputCount: String?) {
		...
		if (fieldsValid){
			...
			addShopItemUseCase.addItemToShopList(shopItem)
			finishWork()
		}
	}
